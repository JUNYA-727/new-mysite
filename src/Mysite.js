    ...
    <>
      <div id="jumphome" style={{ backgroundColor: "black", width: "100%" }}>
        ...
        >
          <div>
            <h1
              style={{ fontSize: "3vh", color: "white", paddingLeft: "5vw" }}
        ...
        <div
          id="jumpskill"
          ref={ref4}
          style={{ backgroundColor: "white", paddingTop: "6vh" }}
        >
          {inview4 && (
            <h1
              ...
              <Card sx={{ maxWidth: 300 }} style={{ margin: "auto" }}>
                ...
                <Collapse in={expanded2} timeout="auto" unmountOnExit>
                  <CardContent>
                    ...
                    <Typography paragraph>開発経験</Typography>
                    <Typography paragraph>
                      ・ポートフォリオサイトの作成(SEO対策にて満点)
                    </Typography>
                    <Typography paragraph>
                      <img
                        src="programming/seo.png"
                        alt="seo"
                        width={"100%"}
                      ></img>
                    </Typography>
              ...
              <Card sx={{ maxWidth: 300 }} style={{ margin: "auto" }}>
                ...
                <Collapse in={expanded3} timeout="auto" unmountOnExit>
                  <CardContent>
                    <Typography paragraph>開発経験</Typography>
                    <Typography paragraph>
                      ･楽天株式会社の1ヶ月実務インターンにて楽天Payのデータベース分析､及びBIツールを用いた自動可視化システムの作成｡
                    </Typography>
                  </CardContent>
                </Collapse>
              </Card>
            ...
            <div>
              {inview1 && (
                <img
                  ...
                  alt=""
                  width={"48%"}
                  style={{ paddingRight: "2%", verticalAlign: "middle" }}
                  className="fadeup1"
                ></img>
              )}
              ...
              {inview1 && (
                <img
                  ...
                  alt=""
                  width={"48%"}
                  style={{ paddingLeft: "2%", verticalAlign: "middle" }}
                  className="fadeup2"
                ></img>
              )}
            </div>
